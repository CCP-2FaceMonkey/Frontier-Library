...
export function ExplorePage() {
  ...
  return (
    <div className="app-placeholder-page explore-page max-w-3xl space-y-8">
      <Link to="/" className="app-placeholder-page__back">
        ← Home
      </Link>
      <h1 className="app-placeholder-page__title">Dapp exploration</h1>
      <p className="text-muted-foreground text-sm leading-relaxed">
        Wallet connection lives in the header (<strong>Connect</strong>). This
        page demonstrates TanStack data layers and Sui GraphQL connectivity.
      </p>

      <section className="space-y-2" aria-labelledby="explore-graphql-heading">
        <h2
      ...
      <section className="space-y-2" aria-labelledby="explore-table-heading">
        <h2
      ...
      <section className="space-y-2" aria-labelledby="explore-virtual-heading">
        <h2
